...
# pgd.min_layer_idx=31 in YAML) on google/gemma-2-9b-it on the chemistry domain
...
python experiments/baselines_2026_04_29/sweep_wanda.py \
  --config experiments/baselines_2026_04_30_pgd_after_sae/config_gemma-2-9b-it_mini.yaml \
