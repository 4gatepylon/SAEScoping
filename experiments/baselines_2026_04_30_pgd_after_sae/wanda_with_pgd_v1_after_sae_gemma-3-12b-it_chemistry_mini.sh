...
# pgd.min_layer_idx=31 in YAML) on google/gemma-3-12b-it on the chemistry domain
# (mini variant). See ./README.md.
...
python experiments/baselines_2026_04_29/sweep_wanda.py \
  --config experiments/baselines_2026_04_30_pgd_after_sae/config_gemma-3-12b-it_mini.yaml \
