#!/usr/bin/env bash
# Attribution-pruning sparsity sweep for google/gemma-2-9b-it on a StemQA subject.
# Usage: ./produce_attribution_gemma2_9b_it_any.sh <dataset_config>
...
# backward; at bf16 the 9B model + caches fit on a single 80GB GPU only at B=1.
#
...
OUTPUT_DIR="$SCRIPT_DIR/pruned_models/gemma2_9b_it_${DATASET_CONFIG}"
TAG="sweep_attribution_gemma2_9b_it_${DATASET_CONFIG}"
