...
# ---------------------------------------------------------------------------
# Taylor saliency map (derived)
# ---------------------------------------------------------------------------

# Stems of source maps that can be used as input to make_taylor_map.
# Validated against the input filename so mismatches are caught early.
