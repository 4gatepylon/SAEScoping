#!/usr/bin/env bash
# run_taylor_070_080.sh
#
# Taylor-saliency prune + PGD recovery sweep for sparsity 0.70 and 0.80.
# Intended for: CUDA_VISIBLE_DEVICES=3 ./run_taylor_070_080.sh
#
# Model:     google/gemma-2-9b-it
# Saliency:  biology/ema_grads_abs.safetensors
# Sparsity:  0.70 then 0.80
# Date:      2026-03-22
