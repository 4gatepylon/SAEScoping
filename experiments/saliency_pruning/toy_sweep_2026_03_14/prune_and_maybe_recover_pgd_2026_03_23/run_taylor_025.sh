...
conda run --no-capture-output -n saescoping python -u \
    ...
    --wandb-run-name     "2026-03-23_taylor_pgd_s025_3Ksteps_biology" \
    "$@"
...
conda run --no-capture-output -n saescoping python -u \
    ...
    --wandb-run-name     "2026-03-23_taylor_pgd_s025_3x1Kiter_biology" \
    "$@"
