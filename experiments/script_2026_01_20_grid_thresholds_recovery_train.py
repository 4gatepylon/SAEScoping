...
DEFAULT_DIST_PATH = (
    Path("/mnt/align4_drive2/adrianoh") / "git" / "ScopeBench" / "sae_training" / "deleteme_cache_bio_only/ignore_padding_True/biology/layer_31--width_16k--canonical/distribution.safetensors"
)
...
@click.option("--checkpoint", "-c", type=str, default=None, help="Checkpoint to resume from")
...
def main(
    ...
    print(f"Running grid search over {len(thresholds_list)} thresholds: {thresholds_list}")
