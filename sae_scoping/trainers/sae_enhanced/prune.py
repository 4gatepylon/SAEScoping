...
def get_pruned_sae(
    ...
    if found_parameters_and_shapes != expected_parameters_and_shapes:
        raise ValueError(
            str_dict_diff(found_parameters_and_shapes, expected_parameters_and_shapes)
        )
    ...
    #     )
    if cfg_dict["metadata"]["model_name"] not in {"google/gemma-3-12b-it", "google/gemma-3-27b-it", "google/gemma-2-9b-it", "gemma-2-9b"}:
        raise ValueError(
